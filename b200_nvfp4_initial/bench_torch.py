"""torch._scaled_mm NVFP4 bench: eager + torch.compile. No inductor
autotune-backends config, this is the "out-of-the-box" behaviour. See
../b200_nvfp4_autotune/ for the corrected version.

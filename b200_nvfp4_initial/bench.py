...
This is the INITIAL bench no inductor autotune-backends config.
See ../b200_nvfp4_autotune/ for the corrected version that lets the
torch.compile autotuner dispatch through cuBLAS.
...
app = modal.App("nvfp4-gemm-b200-initial", image=IMAGE)
